...
if(isset($_POST['mailform'])) {
   if(!empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['mail']) AND !empty($_POST['message'])) {
      ...
      '
      mail("opencinemabrest@gmail.com", "Sujet du message", $message, $header);
...
<html>
   ...
   <body>
      ...
      <form method="POST" action="">
         ...
         <input type="text" name="prenom" placeholder="Votre prenom" value="<?php if(isset($_POST['prenom'])) { echo $_POST['prenom']; } ?>" /><br /><br />
